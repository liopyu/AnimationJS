...
public class PlayerRenderer extends SimplePlayerEventJS {
    ...
    public void renderBodyItem(Object itemStack, float xOffset, float yOffset, float zOffset, float xRotation, float yRotation, float zRotation) {
        ...
        if (obj != null) {
            ...
            poseStack.mulPose(Vector3f.YP.rotationDegrees(yRotationOffset));
            poseStack.mulPose(Vector3f.ZP.rotationDegrees(0));
            poseStack.translate(xOffset, yOffset, zOffset);
            poseStack.mulPose(Vector3f.XP.rotationDegrees(xRotation));
            poseStack.mulPose(Vector3f.YP.rotationDegrees(yRotation));
            poseStack.mulPose(Vector3f.ZP.rotationDegrees(zRotation));

            Minecraft.getInstance().getItemRenderer().renderStatic((ItemStack) obj, ItemTransforms.TransformType.NONE, packedLight, OverlayTexture.NO_OVERLAY, poseStack, buffer, 0);
    ...
    public void renderBodyItem(Object itemStack, float xOffset, float yOffset, float zOffset, float xRotation, float yRotation, float zRotation, int packedLight) {
        ...
        if (obj != null) {
            ...
            Minecraft.getInstance().getItemRenderer().renderStatic((ItemStack) obj, ItemTransforms.TransformType.NONE, pL, OverlayTexture.NO_OVERLAY, poseStack, buffer, 0);
